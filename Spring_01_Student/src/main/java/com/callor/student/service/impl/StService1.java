...
import com.callor.student.service.impl.StDaoImpl;

import java.util.Collections;
import java.util.List;

/*
 * StDao 형 객체를 생성하고 인스턴스가 만들어지는 순간 StDao, StDaoImpl, StService는
 * 상당히 끈끈한 관계가 이루어진다 = 결합이 발생했다
 *
 ...
 * 
 * Sub 로 작성된 클래스 모듈은 반드시 인터페이스를 생성하여 결합도를 낮추는 작업이 필요
 */
...
//    클래스의 생성자를 호출하여 객체를 생성하면 이 객체는 StDao 형 인스턴스가 된다
