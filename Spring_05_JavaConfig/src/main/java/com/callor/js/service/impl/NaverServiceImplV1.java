...
import com.callor.js.models.NaverRestLayout;
...
public class NaverServiceImplV1 extends NaverService<BookVO> {
    ...
    /*
    RestTemplate 사용하여 naver 도서정보 가져오기
     */
    @Override
    public List<BookVO> naverList(String jsonString) throws URISyntaxException {
        /*
        ...
        URI restURI = new URI(jsonString);
...
//        API 에서 XML, JSON 데이터를 한가지 URL로 요청하는 경우 수신한 데이터 Type 을 지정해주기
